...
import { CheckSquare, ClipboardList, ListTodo, type LucideIcon, UserRoundPlus, Users } from "lucide-react";
...
const firstRowActions: ActionCard[] = [
  {
    label: "添加客户",
...
const secondRowActions: ActionCard[] = [
  {
    label: "客户中心",
    href: "/customers",
    icon: Users,
...
function ActionButton({ action }: { action: ActionCard }) {
